...
@WebServlet("/listarPrestamosPorLector")
public class listarPrestamosPorLectorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Correo Lector recibido: " + correoLector);
            List<DtPrestamo> prestamos = prestamoClient.obtenerPrestamosPorLector(correoLector);
